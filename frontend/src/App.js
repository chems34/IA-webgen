...
function App() {
  ...
  const capturePayPalOrder = async (orderId) => {
    try {
      await axios.post(`${API}/paypal/capture-order/${orderId}`);
      setStep(4);
      return true;
    } catch (error) {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {step === 3 && generatedWebsite && (
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-8">
                Procédez au paiement sécurisé avec PayPal pour télécharger votre site web
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="font-semibold text-gray-900 mb-4">Paiement sécurisé PayPal</h3>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700 text-sm">
                        Powered by PayPal - Vos informations bancaires sont protégées
                      </p>
                    </div>
                  </div>
                </div>
