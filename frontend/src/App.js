      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {step === 3 && paymentSession && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-8">
              Procédez au paiement pour télécharger votre site web complet
            </p>
            ...
            <div className="space-y-6">
              <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-t pt-2 flex justify-between text-lg font-bold">
                    <span>Total</span>
                    <span className="text-indigo-600">{paymentSession.amount}€</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <a
                  href={paymentSession.paypal_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block bg-yellow-400 text-black py-3 px-8 rounded-lg font-medium hover:bg-yellow-500 transition-colors"
                >
                  💳 Payer avec PayPal ({paymentSession.amount}€)
                </a>
              </div>

              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-sm text-gray-600 mb-2">
                  Après avoir effectué le paiement, cliquez sur le bouton ci-dessous:
                </p>
                <button
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Votre site web est prêt à être téléchargé et utilisé
              </p>
            </div>
